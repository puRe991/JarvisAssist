...
| **Native Windows cmd.exe** | `curl -L -o downloader.bat https://open-jarvis.github.io/OpenJarvis/downloader.bat && downloader.bat` | [Native Windows install](windows-native.md) |
